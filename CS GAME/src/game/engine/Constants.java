...
public final class Constants {
	...
	public static final int[] CONVEYOR_CELL_INDICES = {2,18,34,54,82,88}; //(Start of the belt)
	...
	//Energy Constants:
	public static final int WININNG_ENERGY = 1000;
	...
	//Power Constants: 
	public static final int POWERUP_CONST = 500;
}
